...
public class HomePage extends javax.swing.JFrame {
    ...
    private void jbackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbackActionPerformed
        ...
        dispose();
        //removes current Window or JFrame
    ...
    private void jconfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jconfirmActionPerformed
        try{
            ...
            //Allocates the data into transferable values to pass through a parameter of a method or constructor

            new Confirmation(name, studID, type, course, section, year).setVisible(true);
            //new Windows or JFrame with required parameters to show data
        }
        catch(NumberFormatException e){JOptionPane.showMessageDialog(null,"Please answer the fields.");}
        //catches an error when there is no answer in the ID box which results in a number format exception
